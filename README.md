...
![Version](https://img.shields.io/badge/Version-2.6.5-red.svg)
...
dependencies {
    implementation "dev.lightdream:file-manager:2.6.5"
    implementation "com.github.L1ghtDream:file-manager:2.6.5"
}
```
