...
![Version](https://img.shields.io/badge/Version-3.2.3-red.svg)
...
dependencies {
    implementation "dev.lightdream:file-manager:3.2.3"
    implementation "com.github.L1ghtDream:file-manager:3.2.3"
}
```
