...
![Version](https://img.shields.io/badge/Version-2.4.3-red.svg)
...
```groovy
dependencies {
    implementation "dev.lightdream:file-manager:2.4.3"
}
```
  </details>
...
```groovy
dependencies {
    implementation "com.github.L1ghtDream:file-manager:2.4.3"
}
```
  </details>
</blockquote></details>
