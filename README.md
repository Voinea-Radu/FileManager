...
![Version](https://img.shields.io/badge/Version-2.7.15-red.svg)
...
dependencies {
    implementation "dev.lightdream:file-manager:2.7.15"
    implementation "com.github.L1ghtDream:file-manager:2.7.15"
}
```
