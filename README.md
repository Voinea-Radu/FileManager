...
![Version](https://img.shields.io/badge/Version-2.3.2-red.svg)
...
```groovy
dependencies {
    implementation "dev.lightdream:file-manager:2.3.2"
}
```
  </details>
...
```groovy
dependencies {
    implementation "com.github.L1ghtDream:file-manager:2.3.2"
}
```
  </details>
</blockquote></details>
