...
![Version](https://img.shields.io/badge/Version-2.4.4-red.svg)
...
```groovy
dependencies {
    implementation "dev.lightdream:file-manager:2.4.4"
}
```
  </details>
...
```groovy
dependencies {
    implementation "com.github.L1ghtDream:file-manager:2.4.4"
}
```
  </details>
</blockquote></details>
