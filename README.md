...
![Version](https://img.shields.io/badge/Version-2.6.0-red.svg)
...
```groovy
dependencies {
    implementation "dev.lightdream:file-manager:2.6.0"
}
```
  </details>
...
```groovy
dependencies {
    implementation "com.github.L1ghtDream:file-manager:2.6.0"
}
```
  </details>
</blockquote></details>
